char b[] = {};
...
int colors[] = {0,11,12,15,1,3};

int x,y,x1,y1,x2,y2,angle,i,d,h,key,top,prevx,prevy;
...
void main(){
	...
	y = 70;
	angle = 90;
	loadtile(map, 16,16,8,7);
	while(1){
		key = getkey();
		if(key == KEY_UP){
			prevx = x;
			prevy = y;
			x = x + (costable[angle])/64;
			y = y + (sintable[angle])/64;
		...
		for(i = 0; i < 64; i+=4){
			...
			d = distance(x, y, x1, y1);
				if(d < 70){
					...
					setcolor(colors[h/3]);
					top = (16 - h)/2;
					line(32 + i/4, 112 + top, 32 + i/4, 112 + h + top);
				}
		}
		delayredraw();
		delayredraw();
