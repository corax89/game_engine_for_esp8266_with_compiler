...
function compile(t) {
	...
	registerFunction('@cir', 'void', ['int', 'x', 'int', 'y', 'int', 'r'], 1, '_circle: \n MOV R1,R0 \n LDC R2,2 \n ADD R1,R2 \n DCIRK R1 \n RET', false, 0);
	registerFunction('fillcircle', 'void', ['int', 'x', 'int', 'y', 'int', 'r'], 1, '_fillcircle: \n MOV R1,R0 \n LDC R2,2 \n ADD R1,R2 \n FCIRK R1 \n RET', false, 0);
	registerFunction('@fcr', 'void', ['int', 'x', 'int', 'y', 'int', 'r'], 1, '_fillcircle: \n MOV R1,R0 \n LDC R2,2 \n ADD R1,R2 \n FCIRK R1 \n RET', false, 0);
