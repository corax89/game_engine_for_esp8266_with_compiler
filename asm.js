...
function asm(s){
	...
	s = s.replace(/'(.)'/g,function(a,b) { return b.charCodeAt(0) });//replace single char
	arr = s.split('\n');
	...
	for(var i = 0; i < variable.length; i++){
		debugVar.push({variable: variable[i++], adress: (variable[i] + debugVarStart)});
	}
	return out;
}