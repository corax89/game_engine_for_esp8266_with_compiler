...
function loadRtttl(){
	...
	//console.log("ddur: " + rtttl.default_dur);
	// get default octave
	c = rtttl.str[rtttl.startposition];
	if(c == 'o'){
	...
	//console.log("doct: " + rtttl.default_oct);
	// get BPM
	c = rtttl.str[rtttl.startposition];
	if(c == 'b'){
...
function playRtttl(){
	...
	// now play the note
	if(note){
		//console.log("Playing: " + scale + ' ' + note + " (" + (notes[(scale - 4) * 12 + note]) + ") " + duration);
